...
const projects = [
    {
        id: 1,
        image: images.blogCafe,
        heading: "Blog de Cafe",
        description: "<p>Pagina sobre cursos sobre preparacion de cafe.</p>",
        websiteLink: "https://blog-de-cafe-five.vercel.app/",
        githubLink: "https://github.com/maximartinatto/blogDeCafe",
        // tecnologias usadas
        html: true,
        css: true
    },
    {
        id: 2,
        image: images.festivalmusicaImage,
        heading: "Festival de Mùsica",
        description: "<p>Pagina sobre festivales y conciertos de musica</p>",
        websiteLink: "https://festival-musica-pi.vercel.app/",
        githubLink: "https://github.com/maximartinatto/festivalMusica",
        // tecnologias usadas
        html: true,
        scss: true,
        javascript: true
    ...
    {
        id: 3,
        image: images.frontendstoreImage,
        heading: "Frontend Store",
        description: "<p>Pagina sobre remeras personalizadas</p>",
        websiteLink: "https://front-end-store-seven.vercel.app/",
        githubLink: "https://github.com/maximartinatto/FrontEndStore",
        // tecnologias usadas
        html: true,
        css: true
    },
